 ...
 * @property {string} type - The type of the public key.
 * @property {string} key - The actual key.
 */
 ...
 * @property {PublicKey} pubkey - The public key of the account.
 * @property {string} mnemonic - The mnemonic of the account.
 */

/**
 * @typedef {AccountDetails[]} AccountsArray
 */
 ...
 * @property {import('@agoric/time/src/types.js').RelativeTimeRecord} startTime Length of time (denoted in seconds) between the time in which the contract is started and the time at which users can begin claiming tokens.
