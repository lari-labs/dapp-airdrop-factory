 ...
 *
 */
const makeSimulateClaim =
  (invitationName = 'makeClaimTokensInvitation') =>
  async (
    t,
    zoe,
    instance,
...
const simulateClaim = makeSimulateClaim();
 ...
 *
 */
const makeClaimInvitation =
  (invitationName = 'makeClaimWithDepositFacetInvitation') =>
  async (
    t,
    zoe,
    instance,
...
export { simulateClaim, makeSimulateClaim };
