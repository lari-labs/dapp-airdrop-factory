...
console.log(JSON.stringify(agoricGenesisAccounts));
...
const proof1 = merkleTreeAPI.generateMerkleProof(
  agoricGenesisAccounts[agoricGenesisAccounts.length - 1].pubkey.key,
  pubkeys
);
const proof2 = merkleTreeAPI.generateMerkleProof(
  ...
  address === "agoric1jng25adrtpl53eh50q7fch34e0vn4g72j6zcml"
    ? {
        ...
        proof: merkleTreeAPI.generateMerkleProof(
          "Axn3Bies1P2bVzvRc23udrmny6YAXxH1o8NYpf3tDnR5",
          pubkeys
        ),
      }
    : {
